...
export const DFS_RESULTS_COPY = {
  ...
  usernameSaved: "DraftKings username saved.",
  standingsHelp: "This file contains the whole contest. Your saved DraftKings username selects your entries automatically. Fees and payouts come from contest history.",
