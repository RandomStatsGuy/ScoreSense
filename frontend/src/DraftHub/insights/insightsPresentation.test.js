...
test("insights heroes name the argument, not a recap slogan", () => {
  assert.match(INSIGHTS_COPY.overview.heading, /league.*history/i);
  ...
  assert.match(INSIGHTS_COPY.spend.support, /spending by team and position/i);
  assert.match(INSIGHTS_COPY.history.support, /contract changes by season/i);
