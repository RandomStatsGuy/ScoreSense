...
export const VIBE_COPY = Object.freeze({
  ...
  support: "Swipe your roster. Scroll the card for hometown, college, and a first-person bio. Start energy raises aura. Sit energy lowers it. The slate updates as you go.",
  chip: "Your read",
  chipDemo: "Demo slate",
  sit: "Sit",
  start: "Start",
  ...
  swipeHint: "Swipe to rate. Scroll the card for the profile.",
  profileAbout: "About",
  profileScroll: "Scroll for the profile",
  railTitle: "Your aura",
  ...
  nextActionDisabled: "Finish the deck to lock the slate.",
  slateTitle: "Vibe slate",
  slateHint: "Projection × your aura. Bye and injured stay out.",
