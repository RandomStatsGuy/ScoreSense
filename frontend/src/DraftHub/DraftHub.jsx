...
export default function DraftHub({ subView, onSubViewChange, onHubContextChange, insightTab, onInsightTabChange, officeTab, onOfficeTabChange, onOpenContractHistory, fantasyActive = true }) {
    ...
    <div className="draft-hub">
      ...
      {!demoMode && effectiveCtx?.mode === "league" && (
        <FantasyChatDock
          leagueId={leagueId || effectiveCtx?.league_id || ""}
          hubContext={effectiveCtx}
          hidden={subView === "room" || !fantasyActive}
        />
      )}
      {!demoMode && (
