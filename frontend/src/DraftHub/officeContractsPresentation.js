...
export const OFFICE_CONTRACTS_COPY = {
  ...
  moreActions: "More",
  queueDrop: "Remove without penalty",
  undoDrop: "Undo drop",
  dropNow: "Remove without penalty",
  dropConfirmLabel: "Queue drop",
  dropConfirmNow: "Remove contract",
  acquired: "Acquired",
  acquiredAuction: "Auction",
  acquiredFaLottery: "FA lottery",
  bidLabel: "Winning bid",
  bidSupport: "The winning bid becomes the salary on the current roster.",
