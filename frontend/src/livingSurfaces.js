...
export const LIVING_SURFACES = Object.freeze({
  ...
  "hub.office.rosters": S({
    ...
    doNot: "Only for leagues with no contracts — Contracts stays auction-only and the two never show together. Same roster editor, money columns off: no Type, salary, Yrs, Schedule, committed, dead cap, or free. Do not add a salary field here, and do not rename this to Rosters — that is the league-wide destination.",
  }),
