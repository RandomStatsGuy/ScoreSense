...
export const LIVING_SURFACES = Object.freeze({
  ...
  "hub.office.current": S({
    ...
    doNot: "Staff may override. Players-tab adds may not. Mark draft complete is a red confirm here — not an unlabeled Setup checkbox. After that confirm, show After draft — not live-auction chrome, and not keepers. After draft leftover matches Rosters (Yrs-0 / expired do not occupy). Pre-draft writes accumulate in a pending-changes tray; Drop executes on save. After draft, Drop and field edits write immediately — no tray. Add records Auction or FA lottery bids. Drop is no dead cap and sits next to Cut; Cut is the penalty path. Extend to keep is teal, Expiring is amber, Cut is red. Live-contracts callout is a disclosure like How cap years work — do not nest a second hub-page. Cap / Sheets is a labeled Related pair. Award names is a Roster management control, not an Insights disclosure.",
  }),
