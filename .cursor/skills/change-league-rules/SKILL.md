...
- Cut dead cap hits only the season the player is cut. Later years of the deal free in full. Dead cap floors to the lower dollar ($1 → $0, $7 → $3 at 50%). Adding a player does not remove that dead cap. Undo cut only if they are not active on any team.
