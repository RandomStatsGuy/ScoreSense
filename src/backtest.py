...
from src.config import BACKTEST_DIR, DEFAULT_TEST_SEASONS, PROCESSED_DATA_DIR
...
def walk_forward_backtest(
    ...
    model.fit(X_train, train_df["Fpts"].values)

    test_df = test_df.copy()
    test_df["model_pred"] = model.predict(prepare_feature_matrix(test_df, position))
