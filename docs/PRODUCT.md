...
| This Week | `week` | Lineup decisions; ScoreSense-only leagues set start/sit here. Calls use the board number, not vibe week. Empty slots say Empty; the CTA is Find {POS} on Free agents. |
