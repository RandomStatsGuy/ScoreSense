...
Commissioner Drop on Contracts and My team removes a player with no dead cap so staff can add them to another team before the draft. After draft it writes immediately — no pending tray. Cut is the penalty path.
